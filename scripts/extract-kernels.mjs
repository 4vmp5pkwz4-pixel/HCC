...
export const ROOTS = [
  ...
  'HR_MSUN', 'ZM_X_SUN', 'ZM_Z_SUN', 'ZM_KRAMERS_C', 'ZM_ES_C', 'zmElectronScattering', 'zmKramers', 'zmOpacity', 'zmCriticalDensity', 'zmDominant', 'zmFeH', 'zmZfromFeH', 'zmEddingtonKappa', 'HCC_BECAUSE', 'windLifetimeWith', 'SEIS_DNU_SUN', 'GYRO_A', 'GYRO_B', 'GYRO_N', 'GYRO_BV_MIN', 'GYRO_SUN_BV', 'GYRO_SUN_PROT', 'GYRO_SUN_AGE_GYR', 'gyroColourTerm', 'gyroPeriod', 'gyroAgeMyr', 'gyroAgeGyr', 'gyroSkumanichRatio', 'GYRO_SKUMANICH_N', 'gyroFractionOfLife', 'GYRO_BALL_K', 'GYRO_BALL_A', 'GYRO_BALL_P', 'GYRO_BALL_Q', 'gyroTeffFromBV', 'gyroBVFromTeff', 'gyroBreakTeff', 'gyroAgeColourError', 'CYC_SYNODIC', 'CYC_DRACONIC', 'CYC_ANOMALISTIC', 'CYC_SIDEREAL_M', 'CYC_TROPICAL_Y', 'CYC_SIDEREAL_Y', 'CYC_APSIDAL_Y', 'CYC_ECLIPSE_LIMIT_DEG', 'cycBeat', 'cycPrecessionFromYears', 'cycClimaticPrecession', 'cycTripleCommensurability', 'cycLongitudeShiftDeg', 'cycSarosSeries', 'oscContFrac', 'OSC_QMAX', 'OSC_TAIL', 'cycleCommensurability', 'cycleByKey', 'CYCLES', 'cyclePhase', 'MERC_GM_SUN', 'MERC_C', 'MERC_A', 'MERC_E', 'MERC_PERIOD_D', 'CYC_ARCSEC_PER_RAD', 'cycPerihelionShift', 'cycPerihelionArcsecPerCentury', 'cycPerihelionPeriodYears', 'CYC_EARTH_A', 'CYC_EARTH_E', 'CYC_EARTH_P', 'cycRelativisticShare', 'CYC_NODE_REGRESSION', 'cycNodalYear', 'CYC_NODAL_Y', 'cycNutationYears', 'cycSarosSolarRoute', 'cycSarosRouteRatio', 'CYC_INEX_LUNATIONS', 'CYC_INEX_DRACONIC_HALVES', 'cycInexDays', 'cycEclipseSeries2', 'cycSarosSeries2', 'cycInexSeries', 'CYC_OBLIQUITY_YR', 'CYC_ECC_SHORT_YR', 'CYC_ECC_LONG_YR', 'CYC_SOLAR_YR', 'CYC_HALE_YR', 'WIND_C', 'WIND_G', 'WIND_MSUN', 'WIND_RSUN', 'WIND_LSUN', 'WIND_YR', 'windMomentumCeiling', 'windCeilingMsunYr', 'windEfficiency', 'WIND_VINF_OVER_VESC', 'windEscapeSpeed', 'windTerminalSpeed', 'windFractionLost', 'windLifetime', 'SEIS_NUMAX_SUN', 'SEIS_TEFF_SUN', 'SEIS_LOGG_SUN', 'SEIS_RHO_SUN', 'SEIS_G', 'seisDnu', 'seisNumax', 'seisRadius', 'seisMass', 'seisDensitySolar', 'seisDensity', 'seisLogg', 'seisTransitDensity', 'seisTransitDensitySolar', 'SEIS_EPS_SUN', 'SEIS_D02_SUN', 'seisMode', 'seisEchelleX', 'seisEnvelopeWidth', 'seisEnvelope', 'HR_LSUN', 'HR_RSUN', 'HR_TSUN', 'HR_C', 'HR_G', 'HR_SIGMA', 'HR_YR', 'HR_GYR',
  ...
  'RES_FAM_LO', 'RES_FAM_HI', 'RES_FAM_N', 'resFamSep', 'resFamZ',
  'resPairSum', 'resDipDepth', 'resSparrow', 'resSepInLambdaOverD',
  ...
  'invEig', 'invNull', 'invRational', 'invFind', 'invClosedForm', 'invClosedFormPhys', 'invAnalyse', 'invNullBasis', 'invUnitDim', 'invPlanckSolve', 'invPlanck', 'invLsq', 'invRat1', 'invLawLib', 'invLaws', 'invLawText', 'fsGrad', 'fsIso', 'fsTri', 'fsFieldLine', 'fsIsingWalls', 'fsColor', 'fsSliceRGBA'
];
