    ...
    '/api/v1/connections': { get: {
      ...
      parameters: [
        ...
        { name: 'kind', in: 'query', required: false,
          schema: { type: 'string', enum: ['typed', 'route', 'refusal', 'sourced'] },
          description: 'typed — a hand-written edge with its relationship kind, claim and epistemic status; route — a number travels the edge; refusal — admissible and declined, carrying the reason; sourced — a cited connection with its URLs and its claim kind' },
