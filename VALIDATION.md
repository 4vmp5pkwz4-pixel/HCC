...
- [ ] S³ → Invariant Nexus: 66 luminous laboratory nodes and 120 typed relations appear across six labelled domains; the HUD reports one connected universe and no console error occurs.
...
- [ ] Nexus JSON export parses, contains 66 nodes and 120 relations, both coordinate arrays, typed/status-bearing edges and the non-metric/non-equivalence disclaimer.
